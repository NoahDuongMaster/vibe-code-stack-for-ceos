...
import { type TUser, useUsers } from '@/entities/user';
...
export function UsersTable() {
  ...
  // eslint-disable-next-line react-hooks/incompatible-library -- TanStack Table intentionally returns mutable callbacks; the table state remains local to this component.

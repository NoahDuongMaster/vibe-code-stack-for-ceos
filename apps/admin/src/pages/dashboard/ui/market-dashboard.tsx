...
} from '@/pages/dashboard/model/market.formatters';
import { createMarketSummary } from '@/pages/dashboard/model/market.mapper';
import type {
  TMarket,
  TMarketsSnapshot,
} from '@/pages/dashboard/model/market.schema';
import { useMarkets } from '@/pages/dashboard/model/use-markets';

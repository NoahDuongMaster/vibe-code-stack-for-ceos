...
type TToolchainContract = {
  expectedNodeMajor: string;
  packageManager: string;
};

type TToolchainInput = TToolchainContract & {
  actualNodeVersion: string;
  actualPnpmVersion: string;
};

type TToolchainResult = {
  nodeVersion: string;
  pnpmVersion: string;
};
...
const readContract = (rootDir: string): TToolchainContract => {
...
export const checkToolchain = (rootDir = ROOT_DIR): TToolchainResult => {
  const active = {
